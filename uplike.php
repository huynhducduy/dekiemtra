...
Bạn có chắc muốn thích bình luận này?<br/>
<input type='hidden' name='idlike' value='".$_GET[id]."'>
<input type='submit' name='uplike' class='cmtLike' style='float: right' value='Thích' /></p></form>";
if (isset($_POST[uplike]))
{
like_up();
?>
<script>
$(".cmtLike").addClass('cmtLiked');
$('.cmtLike').attr('value','Đã thích');
...
{
echo "<p style='text-align: center;'>Bạn đã thích bình luận này rồi!</p>";
}
}
else 
{
