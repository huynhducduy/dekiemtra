...
echo "
                ...
                <h2><a href='#'>Bảng điều khiển chính</a> &raquo; <a href='#' class='active'>Xóa báo cáo đề kiểm tra/a></h2>
                <div id='main'>";
...
if ($_GET['id'] != NULL)
{
$sql1="SELECT * FROM `reports` where `id`='".$_GET[id]."'";
...
$record1=@mysql_num_rows($query1);
	if ($record1 != NULL)
		...
		echo"
				...
				<fieldset>
				<p>Bạn có chắc chắn muốn báo cáo này?</p>
				<input name='id' type='hidden' value='".$_GET[id]."' />
				<input name='delreport' type='submit' value='Xóa' />
				</fieldset>
				</form>";
		}
		else { echo "Có lỗi"; }
