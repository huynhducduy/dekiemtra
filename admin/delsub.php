...
echo "
                ...
                <h2><a href='#'>Bảng điều khiển chính</a> &raquo; <a href='#' class='active'>Xóa đăng ký</a></h2>
                <div id='main'>";
...
$record1=@mysql_num_rows($query1);
	if ($record1 != NULL)
		...
		echo"
				...
				<fieldset>
				<p>Bạn có chắc chắn muốn xóa đăng ký nhận đề kiểm tra mới này?</p>
				<input name='id' type='hidden' value='".$_GET[id]."' />
				<input name='delsub' type='submit' value='Xóa' />
				</fieldset>
				</form>";
		}
		else { echo "Có lỗi"; }
